...
public:
    ...
    std::string getLastSearchKey() const;
    void setLastSearchKey(std::string key);

    std::string getLastSearchKey2() const;
    void setLastSearchKey2(std::string key);

    GJGameLevel* createNewLevel();

    bool getCreatedNewLevel() const;
